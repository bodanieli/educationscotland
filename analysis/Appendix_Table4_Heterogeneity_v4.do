...
su numstudents_sl, detail 
gen byte largeschool = cond(missing(numstudents_sl), .,(numstudents_sl>=r(p50)))
gen smallschool = largeschool==0 
...
label variable largeschool "Large School"
label variable smallschool "Small School"
label variable bottom40simd "Bottom 40% SIMD"
label variable notbottom40simd "Top 60% SIMD"


global groups male female urban rural largeschool smallschool notbottom40simd bottom40simd
...
#delimit;
outreg2 using P1bottomcomp_heterogeneity.xls, append  ctitle("`:var label `z''") 
...
/*OLS: */
areg `y' bottomcomp $spec3 classsize i.wave, absorb(seedcode) cluster(schoolyear) 
...
//SECOND STAGE Without Class Size
