...
local subsample "P4 and P7"
keep if studentstage =="P4" | studentstage=="P7"
...
#delimit;
outreg2 using P4P7SecondStage.xls, append  ctitle("OLS") 
...
#delimit;
cd "$finaloutput09\CFE\MainResults"; 
outreg2 using P4P7SecondStage.xls, append ctitle("2SLS") 
addtext(No. of  Schools, `schools', Covariates, "Yes", Class-Size Instrumented, "No" , School FE, "Yes" , Planner-Calc Only, "Yes", Stage, "`subsample'",  Outcome, "`:var label `y''")
adds(F-Stat, `fstat') 
dec(3)
label nocons
