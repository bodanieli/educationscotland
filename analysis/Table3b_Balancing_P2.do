...
outreg2 using Table3b_Balancing_Planner`noplanner'_`subsample'.xls, replace title()
...
#delimit; 
cd "$finaloutput09/CFE"; 
outreg2 using Table3b_Balancing_Planner`noplanner'_`subsample'.xls, append title() ctitle("`var'") 
...
#delimit; 
cd "$finaloutput09/CFE"; 
outreg2 using Table3b_Balancing_Planner`noplanner'_`subsample'.xls, append title()
addtext(School FE, "No" , Planner-Calc Only, "`noplanner'", Stage, "`subsample'", Outcome, "`var'")
dec(3)
label nocons
