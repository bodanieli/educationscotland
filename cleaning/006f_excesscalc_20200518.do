/*******************************************************************************
This do-file is to construct the composite class instrument using imputed cohort 
sizes from our original sample, for the cohorts where there are only a few students 
or for schools where cohorts are missing.  
